...
// find a cartItem
func (c *cartDatabase) FindCartByUserID(ctx context.Context, userID uint) (cart models.Cart, err error) {
...
// find cart_items
func (c *cartDatabase) FindCartItemByID(ctx context.Context, cartItemID uint) (cartItem models.CartItem, err error) {
...
func (c *cartDatabase) FindCartItemByCartAndProductItemID(ctx context.Context, cartID, productItemID uint) (cartItem models.CartItem, err error) {
...
func (c *cartDatabase) FindAllCartItemsByCartID(ctx context.Context, cartID uint) (cartItems []responses.CartItem, err error) {

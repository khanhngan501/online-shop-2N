...
// Find offer by id
func (c *offerDatabase) FindOfferByID(ctx context.Context, offerID uint) (offer models.Offer, err error) {
...
// Find offer by name
func (c *offerDatabase) FindOfferByName(ctx context.Context, offerName string) (offer models.Offer, err error) {
...
func (c *offerDatabase) FindAllOffers(ctx context.Context,
	pagination requests.Pagination) (offers []models.Offer, err error) {
...
// save a new offer
func (c *offerDatabase) SaveOffer(ctx context.Context, offer requests.Offer) error {
...
func (c *offerDatabase) UpdateOffer(ctx context.Context, offer models.Offer) error {
...
func (c *offerDatabase) FindOfferCategoryCategoryID(ctx context.Context,
	categoryID uint) (offerCategory models.OfferCategory, err error) {
...
func (c *offerDatabase) FindAllOfferCategories(ctx context.Context,
	pagination requests.Pagination) (offerCategories []responses.OfferCategory, err error) {
...
func (c *offerDatabase) SaveCategoryOffer(ctx context.Context,
	categoryOffer requests.OfferCategory) (categoryOfferID uint, err error) {
...
func (c *offerDatabase) FindOfferProductByProductID(ctx context.Context,
	productID uint) (offerProduct models.OfferProduct, err error) {
...
func (c *offerDatabase) FindAllOfferProducts(ctx context.Context,
	pagination requests.Pagination) (offerProducts []responses.OfferProduct, err error) {
...
func (c *offerDatabase) SaveOfferProduct(ctx context.Context,
	offerProduct models.OfferProduct) (productOfferId uint, err error) {

...
func (c *couponUseCase) AddCoupon(ctx context.Context, coupon models.Coupon) error {
...
func (c *couponUseCase) UpdateCoupon(ctx context.Context, coupon models.Coupon) error {
